...
class HskHtmlParserFrench(HTMLParser):  # pylint: disable=W0223
    """
    ...
    def create_word_xml_automatic(self, output_file):
        ...
        """
        deck = ET.Element(
            "deck", attrib={"name": f'HSK {self.dict_content["hskLevel"]} Vocabulaire'}
        )
        ...
        ET.SubElement(
            fields,
            "text",
            attrib={"name": "Traduction", "sides": "01", "lang": "fr-FR"},
        )
        ...
        for word_entry in self.dict_content["words"]:
            ...
            ET.SubElement(card, "chinese", attrib={"name": "Chinois"}).text = hanzi
            ET.SubElement(card, "text", attrib={"name": "Traduction"}).text = definition
    ...
    def create_sentence_xml_automatic(self, output_file):
        ...
        """
        deck = ET.Element(
            "deck", attrib={"name": f'HSK {self.dict_content["hskLevel"]} Phrases'}
        )
